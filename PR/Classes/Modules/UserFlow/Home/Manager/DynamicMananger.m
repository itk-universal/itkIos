...
@property(nonatomic,getter = isInCacheObtain)     BOOL inCacheObtain;
@property(nonatomic,getter = isServerDataArrived) BOOL serverDataArrived;
...
-(void)requestDynamicUIModel:(BOOL)needCache
{
    ...
    HomeAPIInteract *interact = [[HomeAPIInteract alloc]init];
    OSStatus status = [interact interactScuess:^(BaseAPIInteract *interact, id modelData) {
